...
@Component({
  ...
  template: `
    ...
    <i *ngIf="element.paused" class="material-icons afs-video-play-icon" (click)="onClick()">play_circle_outline</i>
    <ng-content></ng-content>
    <div class="afs-video-bar-min" *ngIf="remaining">
      {{remaining.minutes}}:{{remaining.seconds}}
    </div>
    <div class="afs-video-bar-full">
      ...
      <span id="seeker" class="progress-bar" (click)="seek($event)">
        <div class="afs-bar progress" [ngStyle]="{ 'width': seeked + '%'}"></div>
        <div class="afs-bar total"></div>
      </span>
      ...
      <i class="material-icons" (click)="downloadVideo()">ic_file_download</i>
