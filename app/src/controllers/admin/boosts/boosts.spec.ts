...
describe('AdminBoosts', () => {
  ...
  it('accept button should call accept(...) with false as a second parameter (nsfw)', () => {
	...
	//****
	//*****disable line for error fix in `gulp build` 
	//*******niazy 
	//*******1396-07-11
	//****
