  ...
  add(file: any) {
    ...
    for (var i = 0; i < file.files.length; i++) {
      ...
      var data: any = {
        ...
        state: 'created',
        progress: 0,
        category: this.default_category || 12,
      ...
      if (data.type == 'video' && !this.session.isPublic() )
      {
        alert("متاسفانه امکان ارسال ویدئو برای کاربرانی که پروفایل خود را عمومی نکرده اند وجود ندارد . ");
        continue;
      }
